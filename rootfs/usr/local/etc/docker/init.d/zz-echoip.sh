...
# set data directory
DATA_DIR="/data/echoip"
# set config directory
CONF_DIR="/config/echoip"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# root user name
root_user_name="${echoip_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${echoip_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${echoip_USER_NAME:-}"
# normal user password
user_pass="${echoip_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "$CONF_DIR/env/echoip.script.sh" ] && . "$CONF_DIR/env/echoip.script.sh"
# Overwrite the variabes
[ -f "$CONF_DIR/env/echoip.sh" ] && . "$CONF_DIR/env/echoip.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
